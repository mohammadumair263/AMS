...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Johnathan Details</h6>
        </div>
        <div class="card-body">
            <form action="#" method="POST">
                ...
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="form-group col-sm-12 col-md-4">
                        <input type="text" class="form-control" id="roll_no" placeholder="Enter Roll No" name="roll_no" disabled>
                    </div>
                    <div class="form-group col-sm-12 col-md-4">
